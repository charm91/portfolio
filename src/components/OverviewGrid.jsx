  ...
  return (
    <section className="py-12 md:py-16 lg:py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Mobile layout: match original stacked order */}
        <motion.div
          variants={container}
          initial="hidden"
          whileInView="show"
          viewport={{ once: true, margin: "-60px" }}
          className="flex flex-col gap-4 md:gap-5 lg:hidden"
        >
          {/* Profile / About - same as big screen */}
          <motion.article
            variants={item}
          ...
          >
            ...
            <div className="p-5 md:p-6 flex-1">
              ...
              >
                I work at the intersection of product, UX, and development. My
                background allows me to think in systems, design practical
                solutions, and support teams beyond visuals—through clear
                structure, workflows, and implementation-ready designs.
              </p>
            </div>
          </motion.article>
          ...
          >
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="text-sm" style={{ color: textSecondary }}>
                Product, Design & Frontend Experience
              </span>
            </div>
          </motion.article>
          ...
          <motion.article
            ...
            style={{ boxShadow: cardShadow }}
          >
            <div className="flex items-center justify-center gap-2 mb-4 bg-background rounded-full px-4 py-2 w-fit">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true, margin: "-60px" }}
          className="hidden lg:grid lg:grid-cols-2 gap-4 md:gap-5"
        >
          {/* Left column: 3 cards */}
          <div className="flex flex-col gap-4 md:gap-5">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
                <span
                  className="text-sm md:text-base font-normal shrink-0"
                  style={{ color: textSecondary }}
                >
                  Domain Experience
                </span>
            ...
            <motion.article
              variants={item}
              className="rounded-2xl bg-white p-5 md:p-6 flex flex-col flex-1"
              style={{ boxShadow: cardShadow }}
            >
              <div className="flex items-center justify-center gap-2 mb-4 bg-background rounded-full px-4 py-2 w-fit mx-auto">
                <Star className="size-4 fill-[#f97316] text-[#f97316] shrink-0" />
                <span
                  className="text-sm font-medium text-center"
                  style={{ color: textPrimary }}
              ...
              <p
                className="text-sm md:text-base leading-relaxed mb-2 p-5"
                style={{ color: textSecondary }}
              >
                I am happy to recommend Charm, a great UI/UX designer with a
                talent for coding. She has the ability to blend aesthetics and
                ...
                <div className="min-w-0">
                  ...
                  <div>
                    <span
                      ...
                      style={{ color: textSecondary }}
                    >
                      Open to Product Owner roles SEA / Remote • Product-led
                      teams
                    </span>
                  </div>
                </div>
